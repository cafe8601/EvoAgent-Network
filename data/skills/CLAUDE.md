...
- `20-trading/` - Trading systems (11 skills: TA-Lib, VectorBT, Backtrader, CCXT, FinRL, Freqtrade, Korea-Securities-API, Korea-Derivatives-Trading, LS-Securities-Options, Options-Backtesting, Realtime-Trading-System)
- `21-multiagent-learning-system/` - Multi-agent orchestration (1 skill: Multi-Agent Learning System)
- `22-blockchain-agent-security/` - Blockchain security (1 skill: Agent Security Patterns with ZK proofs)
- `23-frontend-design-architect/` - Frontend design (1 skill: Design System Architecture)
- `24-spec-driven-planner/` - Planning methodology (1 skill: Spec-Driven Development)
- `25-backend-architect/` - Backend architecture (1 skill: Backend Architect with Clean/Hexagonal/DDD patterns)
- `26-investment-trading-systems/` - Investment systems (1 skill: Comprehensive Trading Lifecycle)
