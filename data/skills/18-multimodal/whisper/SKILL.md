...
**Platform Optimization**: See [references/platform-optimization.md](references/platform-optimization.md)
- **Windows/Linux (CUDA)**: faster-whisper (4x 속도), whisper_streaming (실시간), WhisperX (화자 분리)
- **Apple Silicon**: Lightning-SimulWhisper (18x 속도), MLX Whisper
- **크로스플랫폼**: whisper.cpp (C++ 구현, 모든 플랫폼 지원)
